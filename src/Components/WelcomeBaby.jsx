    ...
    <div className="lg:py-24  pt-32  p-3  mx-auto">
      ...
      <div className="md:px-10 px-4">
        <p className="font-bold poppins py-8 text-2xl">
          Hire the Best Balloon Decorators for Your Kid's welcome Party
        </p>
        <p className="font-bold">
          Celebrate the arrival of your precious baby with stunning balloon
          décor that fills your space with love and joy! Our expert decorators
          create heartwarming designs, from charming balloon arches and adorable
          centerpieces to personalized arrangements that match your theme.
          Whether you’re planning an intimate home celebration or a grand
          welcome party, we tailor every detail to make the moment extra
          special. Let us handle the decorations while you cherish this
          beautiful milestone with family and friends. Book your baby welcome
