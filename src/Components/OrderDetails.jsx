                ...
                <div className="bg-white rounded-lg px-4 overflow-y-auto relative text-sm ">
                    ...
                    <div className="space-y-4  px-4 mt-2">
                        ...
                        <ul className="list-disc">
                            ...
                            <li> Please carefully review the Cancellation and Refund policies before making a purchase, as you will be held accountable to these policies. To cancel or reschedule, please email us at infolavisheventzz@gmail.com or reach out to us via call or WhatsApp number at +91 9620558000. </li>
                        </ul>
                        <h1 className="font-bold text-black">
                            Reschedule Policy:
                        </h1>
