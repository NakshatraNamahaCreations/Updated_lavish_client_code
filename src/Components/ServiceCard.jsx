...
const ServiceCard = ({ service, title }) => {
  ...
  return (
    <div className="relative mx-auto group mb-4 shadow-lg rounded-xl overflow-hidden hover:shadow-lg transition-shadow duration-300 break-inside-avoid md:px-3 md:pt-4  w-[190px] md:h-[300px]  md:w-[300px] lg:w-[300px] lg:h-[360px] h-[300px] border border-gray-300">
      {/* Wishlist Icon */}
      <div
