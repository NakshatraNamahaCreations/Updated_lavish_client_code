...
// const MultiSelect = ({ disabled, defaulyballoonsColors }) => {
//   console.log("defaulyballoonsColors", defaulyballoonsColors);

//   // Initialize with 'default' selected by default
//   const [selectedOptions, setSelectedOptions] = useState([...defaulyballoonsColors]);
...
//   // Check if the selected colors match the default colors
//   const isDefaultSelected = selectedOptions.every((color) => defaulyballoonsColors.includes(color));
...
//       );
//     } else {
//       if (selectedOptions.includes("default") && selectedOptions.length === 1) {
...
//   return (
//     <div className="col-span-2p-4 rounded-2xl bg-transparent">
...
//             type="checkbox"
//             value="default"
//             checked={selectedOptions.includes("default")}
//             onChange={() => handleSelection("default")}
//             className="form-checkbox text-primary hidden"
...
//           <p>Pick color as per your choice</p>
