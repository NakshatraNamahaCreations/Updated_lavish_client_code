...
const iconsArray = [
    ...
    { name: "Youtube", icon: youtube, link: "https://www.youtube.com/channel/UCvMX-R5xbMD4H8to1P4nbcQ" },
];
        ...
        <div className='bg-gray-200 relative font-medium'>
            ...
            <div className='absolute -top-24 left-1/2 transform -translate-x-1/2 w-[90%] max-w-[1200px] rounded-xl'>
                <div className='relative'>
                    ...
                    <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center'>
                        ...
                        <button className='bg-primary px-4 py-2 mt-2 rounded-md text-sm sm:text-base' onClick={() => handleNavigation("/contact")}>
                            Message
                        </button>
                    </div>
                </div>
            ...
            <div className='mt-[250px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-36 px-6 sm:px-10'>
                <div>
                    ...
                    <p className='pt-4 font-bold text-primary  playfair-display text-lg sm:text-xl'>Lavish Eventzz</p>
                    <p className='max-w-72 montserrat text-sm sm:text-base text-gray-600'>
                        Trust us to bring your dreams to life with our creative expertise and seamless execution. We create memories!
                    </p>
                </div>
                ...
                <div className='flex flex-col justify-between'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <a
                            href="mailto:support@lavisheventzz.com?subject=Enquiry%20about%20Services&body=Hi%20Lavish%20Events%2C%0A%0AI'm%20interested%20in%20your%20event%20decor%20services.%20Please%20get%20back%20to%20me.%0A%0AThanks!"
