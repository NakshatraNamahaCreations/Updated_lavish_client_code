...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-6xl mx-auto px-6 py-12 bg-white text-gray-800 mt-16">
      ...
      <section className="mb-8">
        ...
        <p className="mt-2">
          ...
          <a href="mailto:lavisheventzz@gmail.com" className="text-blue-600 underline ml-1">lavisheventzz@gmail.com</a>.
        </p>
      </section>
